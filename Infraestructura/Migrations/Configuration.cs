    ...
    internal sealed class Configuration : DbMigrationsConfiguration<DataContext>
    {
        ...
        protected override void Seed(DataContext context)
        {
            try
            {
                ...
                {
                    context.Contadores.Add(new Contador { EstaEliminado = false, Valor = 0, TipoComprobante = Aplicacion.Constantes.TipoComprobante.A });
                    context.Contadores.Add(new Contador { EstaEliminado = false, Valor = 0, TipoComprobante = Aplicacion.Constantes.TipoComprobante.B });
                    context.Contadores.Add(new Contador { EstaEliminado = false, Valor = 0, TipoComprobante = Aplicacion.Constantes.TipoComprobante.C });
                    context.Contadores.Add(new Contador { EstaEliminado = false, Valor = 0, TipoComprobante = Aplicacion.Constantes.TipoComprobante.NotaCredito });
                    context.Contadores.Add(new Contador { EstaEliminado = false, Valor = 0, TipoComprobante = Aplicacion.Constantes.TipoComprobante.Presupuesto });
                    context.Contadores.Add(new Contador { EstaEliminado = false, Valor = 0, TipoComprobante = Aplicacion.Constantes.TipoComprobante.Remito });
