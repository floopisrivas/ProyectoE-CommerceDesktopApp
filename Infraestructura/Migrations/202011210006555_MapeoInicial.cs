namespace Infraestructura.Migrations
{
    ...
    public partial class MapeoInicial : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        CodigoBascula = c.String(maxLength: 400, unicode: false),
                        EstaEliminado = c.Boolean(nullable: false),
                        Deposito_Id = c.Long(),
                    })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.Deposito", t => t.Deposito_Id)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Configuracion", "Deposito_Id", "dbo.Deposito");
            ...
            DropIndex("dbo.Configuracion", new[] { "Deposito_Id" });
